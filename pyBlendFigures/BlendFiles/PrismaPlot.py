...
class PrismaPlot:
        ...
        for row_i in range(self.row_count):
            for col_i in range(self.col_count):
                try:
                    ...
                    self.make_text_box(name, col_i, position, previous_height)
    ...
    def make_text_box(self, name, col_i, position, previous_height):
        ...
        self.make_bounding_box(x, y, x_d, y_d, name, obj)

    def make_bounding_box(self, x, y, x_d, y_d, name, obj):
